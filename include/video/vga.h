...
static inline unsigned char vga_mm_r (void  *regbase, unsigned short port)
{
	return readb ((void*)((uint32_t)regbase + port));
}

static inline void vga_mm_w (void  *regbase, unsigned short port, unsigned char val)
{
	writeb (val, (void*)((uint32_t)regbase + port));
}

static inline void vga_mm_w_fast (void  *regbase, unsigned short port,
				  unsigned char reg, unsigned char val)
{
	writew (VGA_OUT16VAL (val, reg), (void*)((uint32_t)regbase + port));
}

static inline unsigned char vga_r (void  *regbase, unsigned short port)
{
	if (regbase)
...
static inline void vga_w (void  *regbase, unsigned short port, unsigned char val)
{
	if (regbase)
...
static inline void vga_w_fast (void  *regbase, unsigned short port,
			       unsigned char reg, unsigned char val)
{
	if (regbase)
...
static inline unsigned char vga_rcrt (void  *regbase, unsigned char reg)
{
        vga_w (regbase, VGA_CRT_IC, reg);
        return vga_r (regbase, VGA_CRT_DC);
}

static inline void vga_wcrt (void  *regbase, unsigned char reg, unsigned char val)
{
...
static inline unsigned char vga_mm_rcrt (void  *regbase, unsigned char reg)
{
        vga_mm_w (regbase, VGA_CRT_IC, reg);
        return vga_mm_r (regbase, VGA_CRT_DC);
}

static inline void vga_mm_wcrt (void  *regbase, unsigned char reg, unsigned char val)
{
#ifdef VGA_OUTW_WRITE
...
static inline unsigned char vga_rseq (void  *regbase, unsigned char reg)
{
        vga_w (regbase, VGA_SEQ_I, reg);
        return vga_r (regbase, VGA_SEQ_D);
}

static inline void vga_wseq (void  *regbase, unsigned char reg, unsigned char val)
{
#ifdef VGA_OUTW_WRITE
...
static inline unsigned char vga_mm_rseq (void  *regbase, unsigned char reg)
{
        vga_mm_w (regbase, VGA_SEQ_I, reg);
        return vga_mm_r (regbase, VGA_SEQ_D);
}

static inline void vga_mm_wseq (void  *regbase, unsigned char reg, unsigned char val)
{
#ifdef VGA_OUTW_WRITE
...
static inline unsigned char vga_rgfx (void  *regbase, unsigned char reg)
{
        vga_w (regbase, VGA_GFX_I, reg);
        return vga_r (regbase, VGA_GFX_D);
}

static inline void vga_wgfx (void  *regbase, unsigned char reg, unsigned char val)
{
#ifdef VGA_OUTW_WRITE
...
static inline unsigned char vga_mm_rgfx (void  *regbase, unsigned char reg)
{
        vga_mm_w (regbase, VGA_GFX_I, reg);
        return vga_mm_r (regbase, VGA_GFX_D);
}

static inline void vga_mm_wgfx (void  *regbase, unsigned char reg, unsigned char val)
{
#ifdef VGA_OUTW_WRITE
...
static inline unsigned char vga_rattr (void  *regbase, unsigned char reg)
{
        vga_w (regbase, VGA_ATT_IW, reg);
        return vga_r (regbase, VGA_ATT_R);
}

static inline void vga_wattr (void  *regbase, unsigned char reg, unsigned char val)
{
        vga_w (regbase, VGA_ATT_IW, reg);
...
static inline unsigned char vga_mm_rattr (void  *regbase, unsigned char reg)
{
        vga_mm_w (regbase, VGA_ATT_IW, reg);
        return vga_mm_r (regbase, VGA_ATT_R);
}

static inline void vga_mm_wattr (void  *regbase, unsigned char reg, unsigned char val)
{
        vga_mm_w (regbase, VGA_ATT_IW, reg);
